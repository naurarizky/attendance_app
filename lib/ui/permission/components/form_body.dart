...
class FormBody extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    String dropValueCategories = "Pleaser Choose";
      ...
      child: Column(
        ...
        children: [
          TextField(
            ...
            hintText: "Pleaser enter your name",
            hintStyle: TextStyle(
              fontSize: 14,
              color: Colors.grey
            ),
              ...
              child: DropdownButton(
                ...
                items: categoriesList.map((value){
                  return DropdownMenuItem(
                    ...
                    //untuk mengkonversi sebuah data acak menjadi berurutan pada list
                }).toList(),
                          ...
                          Expanded(
                            child: TextField(
                              ...
                              onTap: ()async{
                                ...
                                if(pickedDate !=null ){
                                  //untuk mengonversikan data detail tanggal yg diambil dari picker date menjadi format dd mm yy
